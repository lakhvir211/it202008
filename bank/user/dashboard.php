...
<td><?php echo $u['acount_status'] ?></td>
<td><?php echo $u['acount_type'] ?></td>
<td>
<?php if($u['acount_status'] !=="deactivate"){?>
<div class="dropdown">
  <button type="button" class="btn btn-info btn-md dropdown-toggle" data-toggle="dropdown">
   Select Action
  </button>
  <div class="dropdown-menu">
    <a class=" dropdown-item"href="deposit.php?id=<?php echo $u['id'] . "&type=" . $u['acount_type'] ?>">Deposit</a>
<a class="dropdown-item"href="withdraw.php?id=<?php echo $u['id'] . "&type=" . $u['acount_type'] ?>">withdraw</a>
<a class="dropdown-item"href="intrnsfer.php?id=<?php echo $u['id'] . "&type=" . $u['acount_type'] ?>">Internal Transfer</a></a>
<a class="dropdown-item"href="extransfer.php?id=<?php  echo $u['id'] . "&type=" . $u['acount_type'] ?>">External Transfer</a>
<a class="dropdown-item"href="world.php?id=<?php echo $u['id'] . "&type=" . $u['acount_type'] ?>">World Transfer</a>
<a class="dropdown-item"href="hist.php?id=<?php echo $u['id'] . "&type=" . $u['acount_type'] ?>">All Transitions</a>
<a class="dropdown-item"href="close.php?id=<?php echo $u['id'] . "&type=" . $u['acount_type'] ?>">Close Acount</a>
